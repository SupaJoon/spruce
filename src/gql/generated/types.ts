...
export type CodeChangesTableFileDiffsFragment = { fileName: string, additions: number, deletions: number, diffLink: string, description: string };
...
export type CodeChangesQuery = { patch: { id: string, moduleCodeChanges: Array<{ branchName: string, htmlLink: string, rawLink: string, fileDiffs: Array<CodeChangesTableFileDiffsFragment> }> } };
...
export type CommitQueueQuery = { commitQueue: { projectId?: Maybe<string>, message?: Maybe<string>, owner?: Maybe<string>, repo?: Maybe<string>, queue?: Maybe<Array<{ issue?: Maybe<string>, enqueueTime?: Maybe<Date>, patch?: Maybe<{ id: string, author: string, description: string, moduleCodeChanges: Array<{ rawLink: string, branchName: string, htmlLink: string, fileDiffs: Array<CodeChangesTableFileDiffsFragment> }> }> }>> } };
...
export type HostQuery = { host?: Maybe<{ id: string, hostUrl: string, distroId?: Maybe<string>, tag: string, provider: string, startedBy: string, user?: Maybe<string>, status: string, lastCommunicationTime?: Maybe<Date>, distro?: Maybe<{ bootstrapMethod?: Maybe<string> }>, runningTask?: Maybe<{ id?: Maybe<string>, name?: Maybe<string> }> }> };
...
export type PatchQuery = { patch: { id: string, description: string, projectID: string, githash: string, patchNumber: number, author: string, version: string, status: string, activated: boolean, alias?: Maybe<string>, taskCount?: Maybe<number>, commitQueuePosition?: Maybe<number>, baseVersionID?: Maybe<string>, canEnqueueToCommitQueue: boolean, parameters: Array<{ key: string, value: string }>, duration?: Maybe<{ makespan?: Maybe<string>, timeTaken?: Maybe<string> }>, time?: Maybe<{ started?: Maybe<string>, submittedAt: string, finished?: Maybe<string> }>, variantsTasks: Array<Maybe<{ name: string, tasks: Array<string> }>> } };
